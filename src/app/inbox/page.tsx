...
export default function InboxPage() {
  ...
  return (
    <div className={`p-6 ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className={`nt-inbox-table ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow`}>
        <TableHeader
            ...
            <tbody className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} divide-y divide-gray-200 dark:divide-gray-700`}>
              {paginatedMessages.map((message) => (
                <tr 
                  key={message.id} 
                  className={`${
                    !message.read ? theme === 'dark' ? 'bg-gray-700' : 'bg-gray-50' : ''
                  } cursor-pointer transition-colors duration-200 ${theme === 'dark' ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} group`}
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white group-hover:text-indigo-600 transition-colors duration-200">
                    {message.from}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                    <div className="flex flex-col">
                      ...
                      <span className="text-gray-500 dark:text-gray-400 truncate max-w-md group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-200">{message.content}</span>
                    </div>
                  </td>
